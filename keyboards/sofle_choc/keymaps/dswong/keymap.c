...
/* LOWER
 * ,----------------------------------------.                    ,-----------------------------------------.
 * | ____ |  –   |  €   |  £   |  ¥   | Pscr |                    | Ins  | Home | PgUp |  - _ | = +  | ____ |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F4  |      |      |      |      | NumLk|                    | Del  | End  | PgDn | KP_7 | KP_8 | KP_9 |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ____ |      |      |      |      |      |-------.    ,-------|   /  |  Up  |  *   | KP_4 | KP_5 | KP_6 |
 * |------+------+------+------+------+------| ____  |    | ____  |------+------+------+------+------+------|
 * | Caps | Undo |  Cut | Copy | Paste|      |-------|    |-------| Left | Down | Right| KP_1 | KP_2 | KP_3 |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | ____ | ____ | ____ |TO(0) | / ____  /       \ ____ \  |TO(3) |  .   | ] }  | KP_0 |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_LOWER] = LAYOUT(
    _______, KC_ENDASH, CS_EUR, CS_GBP, CS_JPY,   KC_PSCR,                         KC_INS,  KC_HOME, KC_PGUP, KC_MINUS,  KC_EQUAL, _______,
    KC_F4,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_NUM,                          KC_DEL,  KC_END,  KC_PGDN, KC_KP_7,   KC_KP_8,  KC_KP_9,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,                         KC_PSLS, KC_UP,   KC_PAST, KC_KP_4,   KC_KP_5,  KC_KP_6,
    KC_CAPS, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, XXXXXXX, _______,       _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_KP_1,   KC_KP_2,  KC_KP_3,
                      _______, _______, _______,    TO(0), _______,       _______, TO(3),   KC_PDOT, KC_RBRC, KC_KP_0
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |LShift|  =   |  -   |  +   |   {  |   }  |-------|    |-------|   [  |   ]  |   ;  |   :  |   \  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | ____ | ____ | ____ |TO(0) | / ____  /       \ ____ \  |TO(3) |RSHIFT|      |      |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_RAISE] = LAYOUT(
    ...
    KC_LSFT, KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,       _______, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, XXXXXXX,
                     _______, _______, _______, TO(0),   _______,       _______, TO(3),   KC_RSFT, XXXXXXX, XXXXXXX
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ____ | Spd- | Val- | Sat- | Hue- |Mode- |-------.    ,-------|      | VOLDO| MUTE | VOLUP|      |      |
 * |------+------+------+------+------+------|RGBTogg|    |RL_Rset|------+------+------+------+------+------|
 * | ____ |Static|Breath|Snake |Knight|RL_CVG|-------|    |-------|      | PREV | PLAY | NEXT |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_ADJUST] = LAYOUT(
    ...
    _______, RGB_SPD, RGB_VAD, RGB_SAD, RGB_HUD, RGB_RMOD,                      XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX,
    _______, RGB_M_P, RGB_M_B, RGB_M_SN, RGB_M_K, RL_CVGRN, RGB_TOG,   RL_RST,  XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case RL_IND: 
        if (record->event.pressed) {
                rgblight_sethsv(174, 75, 100);
                return false;
            }
            break;
        case RL_VIO: 
        if (record->event.pressed) {
                rgblight_sethsv(194, 100, 100);
                return false;
            }
            break;
        case RL_WHT:
